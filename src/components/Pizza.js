...
const Pizza = () => {
  ...
  return (
    <div className="">
      <h1 className="text-2xl font-semibold  inline-flex ga-4  p-4  items-center justify-center">
        Total Pizzabases:
        <span className="block rounded-md   w-12 h-12  grid place-items-center">{pizzas}</span>
      </h1>
      <button
